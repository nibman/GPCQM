...
Teams =
{
    keys:["objectId", "teamId", "teamName", "teamDescription"],

    resultModel:["objectId", "teamId", "teamName", "teamDescription"],
                ...
                object.save(null,
                    {
                        ...
                        {
                            Teams.resultModel = keys.get('keyNames');
                            keyNamesSaved(Teams.resultModel);
                        },
                        error:function(object, error)
                        {
                            err != null ? err(error) : Teams.errorDefault(error);
                        }
                    });
            },
            error:function(object, error)
    ...
    getKeyNames:function(keySetID, keyNamesReceived, err)
    {
        ...
        query.first(
        {
            ...
            {
                Teams.resultModel = keys.get('keyNames');
                keyNamesReceived(Teams.resultModel);
            },
            error:function(object, error)
            {
                err != null ? err(error) : Teams.errorDefault(error);
    ...
    getTeamByID:function(id, successCB, err)
    {
        var team = Parse.Object.extend("team");
        var query = new Parse.Query(team);
        var k = Teams.resultModel;
        query.get(id,
        {
            success:function(team)
            {
                if (Teams.returnType != "Array")
                {
                    var e =  { };
    ...
    getAllTeam:function(successCB, err)
    {
        var team = Parse.Object.extend("Team");
        var query = new Parse.Query(team);
        var teams = query.ascending("team");
    ...
    saveTeam:function(teamID, teamObj, successCB, err)
    {
        if (teamID != null)
        {
            var team = Parse.Object.extend("Team");
            var query = new Parse.Query(team);
             console.log( "TEAM 2 x: " + teamObj );
            query.get(teamID,
            {
                success:function(team)
                {
                    for(var e in teamObj)
                    {
                        if (e != "objectId")
                        {
                            team.set(e, teamObj[e]);
                        }
                    }
                    team.save(null, {
                        success:function(team)
        ...
        {
            team.createTeam(teamObj,successCB, e);
        }
    },
    createTeam:function(teamObj, successCB, err)
    {
        var Team = Parse.Object.extend("Team");
        var a = new Team();
    ...
    deleteTeam:function(teamID, successCB, err)
    {
        var Team = Parse.Object.extend("Team");
            var query = new Parse.Query(Team);
            query.get(teamID,
...
Teams.setKeyNames("gpcqm2", ["teamId", "teamName", "teamDescription"],function(e){});
...
function teamsReceived(a)
{
    var _id = 0;

 for (var i=0; i<a.length; ++i)
 {
     _id = a[i][0] > _id ? a[i][0] : _id;
    var tr = document.createElement('tr');
 ...
 document.getElementById("teamId").value = _id + 1;
...
$(document).on('confirmation', '.remodal', function () {
  if (checkform(form))
  {
    ...
    Teams.createTeam(fields, teamCreated, errorReceived);
  }
});

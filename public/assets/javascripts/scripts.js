...
Athletes = 
 {
    keys:["objectId", "firstName", "lastName", "athleteID", "dossard", "hrm", "srmPowerMeter", 
            ...
            "garminSpeedCadence", "team", "gps", "wheelCir", "country", "dob"],
    ...
    resultModel:["firstName", "lastName", "athleteID", "dossard", "hrm", "srmPowerMeter", 
            ...
            "garminSpeedCadence", "team", "gps", "objectId", "country", "dob"],
...
// Athletes.setKeyNames("gpcqm1", ["firstName", "lastName", "athleteID", "dossard", "hrm", "srmPM", "PM", "vectorPM", "quarkPM", "SC", "garminSC", "team", "gps","objectId"],function(e){});
...
function addRowHandlers() {
  ...
  for (i = 0; i < dynamicTable.length; i++) {
    console.log(i);
    var currentRow = dynamicTable.rows[i];
 ...
 for (var i=0; i<a.length; ++i)
 {
    ...
    for (j = 0; j <a[i].length; j++)
    {
      ...
      for (b = 0; b<hideFieldsPosition.length; b++){
        if (j == hideFieldsPosition[b])
        {
          td.className += "hideField";
        }
      }
